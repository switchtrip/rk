...
<div class="pt-24 p-4 sm:p-8 sm:pt-32 lg:pt-36 space-y-10 mx-auto max-w-7xl">
    <div id="classes" class="space-y-8">
      ...
      <p class="text-sm">
        Both offline and online classes are provided by Surbhi Music Academy for all age groups. Depending upon the interest, students can opt for flute or harmonica or both. One on one classes are also possible. All classes are primarily taken by the founder of the Academy Shri Sunil Patil.
      </p>
    </div>
    <TabGroup class="p-4">
